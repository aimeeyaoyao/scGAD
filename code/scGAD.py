    ...
    for epoch in range(args.epochs + 1):
        if epoch % args.interval == 0:
            ...
            for i in range(total_classes):
                test_distance = torch.sum(torch.square(test_embeddings.unsqueeze(1) - cluster_centers), dim=2)
...
if __name__ == "__main__":
    ...
    for i in range(len(data_list)):
        ...
        try:
            ...
            print("we meet error for dataset {}".format(dataname))
    ...
    output = pd.DataFrame(output,
                          columns=["cluster number", "total classes", "shared classes", "batch ratio", "mode",
                                   ...
                                   "overall1", "seen1", "novel1", "epoch1", "overall2", "seen2", "novel2", "epoch2",
